    ...
    return (
        <div className='bg-[#92313b] w-full h-full text-white pt-20'>
            ...
            <div className='lg:max-w-7xl mx-auto'>
                ...
                <p className='text-lg text-white text-center py-20 tracking-tighter px-5'>Copyright 2023. 이지연 all rights reserved.<br /><br /><span className='lg:text-sm text-xs'>본 사이트는 상업적 목적이 아닌 이지연 개인 포트폴리오 사이트로 제작되었습니다.<br />일부 이미지 및 폰트 등은 그 출처가 따로 있음을 밝힙니다. <br /><br />해당 사이트는 1920*1080 해상도에 최적화 되었습니다.<br /><br />마지막 수정일 : 2023.11.08</span></p>
            </div>
        </div>
    )
}
