...
function GoTop() {
    ...
    return (
        <>
            ...
            <NavLink to='https://open.kakao.com/me/o2asis'><div className='fixed lg:bottom-[15%] md:bottom-[15%] bottom-[13%] right-[5%] cursor-pointer lg:w-20 lg:h-20 md:w-20 md:h-20 w-16 h-16 bg-black rounded-full text-white font-bold z-[49] duration-500 lg:text-3xl text-2xl hover:bg-yellow-500 hover:text-black flex items-center justify-center'><FontAwesomeIcon icon={faComments} /></div></NavLink>
        </>
    )
}
