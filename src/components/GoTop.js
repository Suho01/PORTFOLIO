...
function GoTop() {
    ...
    return (
        <>
            ...
            <NavLink to='https://open.kakao.com/me/o2asis'><div className={`fixed bottom-[17%] right-[5%] cursor-pointer lg:w-20 lg:h-20 md:w-20 md:h-20 w-16 h-16 rounded-full font-bold z-[49] duration-500 lg:text-3xl text-2xl ${theme === 'light' ? 'bg-black text-white hover:bg-yellow-500 hover:text-black' : 'bg-yellow-500 text-black hover:bg-black hover:text-white'} flex items-center justify-center`}><FontAwesomeIcon icon={faComments} /></div></NavLink>
        </>
    )
}
