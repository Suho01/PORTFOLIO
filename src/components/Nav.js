    ...
    return (
        <div className='lg:max-w-7xl md:max-w-3xl sm:max-w-sm mx-auto'>
            <div className={`fixed left-1/2 -translate-x-1/2 ${theme === 'light' ? 'bg-white' : 'bg-[#272929]'} lg:w-full z-[999] shadow-md lg:block hidden`}>
                <ul className='lg:max-w-7xl mx-auto flex justify-between py-12'>
                    <li><NavLink className={`${theme === 'light' ? 'text-black' : 'text-white'} font-bold`}>FD Jiyeon's Portfolio</NavLink></li>
                    {
                        NavArray.map((e, i) => {
                            return (
