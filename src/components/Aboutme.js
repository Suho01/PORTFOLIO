            ...
            <div className='lg:max-w-7xl lg:h-screen mx-auto relative dark:text-white'>
                ...
                <div className='lg:flex px-[2%]'>
                    ...
                    text-center md:mb-20 px-[2%]'>
                        <span className='font-bold lg:text-xl relative after:w-4 after:h-1 after:bg-[#D83546] after:absolute after:left-0 after:-top-1'>Profile</span><br /><span className=''>이름</span> : 이지연 (Lee Jiyeon)<br />나이 : 1997.03.06 (2023년 기준 만 26세)<br />E-mail : suhoprimavera@gmail.com<br />MBTI : ENFJ 정의로운 사회운동가<br /><span className='hover:font-bold'>#협업좋아요 </span><span className='hover:font-bold'>#선도자 </span><span className='hover:font-bold'>#MZ막차</span><br /><br /><br />
