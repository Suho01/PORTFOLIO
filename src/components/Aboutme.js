            ...
            <div className='lg:max-w-7xl lg:h-screen mx-auto relative dark:text-white'>
                ...
                <div className='lg:flex px-[2%]'>
                    ...
                    text-center md:mb-20 px-[2%] leading-relaxed`}>
                        <li className={`font-bold text-xl relative after:w-4 after:h-1 after:bg-[#D83546] after:absolute after:left-0 after:-top-1 ${theme === 'light' ? 'text-black' : 'text-white'} pb-2`}>Profile</li>
                        ...
                        <li className={`font-bold text-xl relative after:w-4 after:h-1 after:bg-[#D83546] after:absolute after:left-0 after:-top-1 ${theme === 'light' ? 'text-black' : 'text-white'} pb-2`}>Developing Frontend</li>
                        ...
                        <li className={`font-bold text-xl relative after:w-4 after:h-1 after:bg-[#D83546] after:absolute after:left-0 after:-top-1 ${theme === 'light' ? 'text-black' : 'text-white'} pb-2`}>Experiences</li>
